...
# Obtain user infromation from the user ID
def getUserInfo(user_id):
    user = User.query.filter_by(id=user_id).one()
    return user

#Obtain user ids from the user email
def getUserID(email):
    try:
...
#Custom logout method based on which login has been used
...
#Show the category items index page
...
#Specific item index page rendering
